...
public enum Statistic 
{
	...
	private Statistic(org.bukkit.Statistic stat,String tostring, String name, String unit)
	{
		this(stat, tostring, name, unit, EntityType.UNKNOWN);
	}
	

	private Statistic(org.bukkit.Statistic stat,String tostring, String name, String unit, EntityType ent)
	{
		this.Name = name;
		this.Unit = unit;
		this.Stat = stat;
		...
		{
			this.isMobKills = false;
		}
		else
		{
			this.isMobKills = true;
		}
	}
