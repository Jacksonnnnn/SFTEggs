        ...
        if (args.length > 0) {
            if (!StatSet.contains(args[0].toUpperCase())) {
                ...
                for (String stat : StatSet) {
                    sb.append(ChatColor.GRAY).append(stat).append(ChatColor.WHITE).append(", ");
                }
                ...
                if (args.length > 2) {
                    if (!EggHandler.permMap.containsKey(args[2])) {
                        ...
                        for (String s : EggHandler.permMap.keySet()) {
                            sb.append(ChatColor.GRAY).append(s).append(ChatColor.WHITE).append(", ");
                        }
                    ...
                    if (args.length > 3) {
                        ...
                        if (EggType.parse.toEggValue(args[3]) == -1) {
                            ...
                            for (EggType egg : EggType.values()) {
                                sb.append(ChatColor.GRAY).append(egg.name()).append(ChatColor.WHITE).append(", ");
                            }
                            sender.sendMessage(sb.toString());
                            return true;
                        }
                        ...
                        if (args.length > 4) {
                            ...
                            //TODO replace me, figure out a good way to do this, could be null
